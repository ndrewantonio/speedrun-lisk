...
contract PriceFeed is MainDemoConsumerBase {
    ...
    function getBtcPrice() public view returns (uint256) {
        ...
        /**
     * @notice Get the latest LSK/USD price
     * @return price The current LSK price in USD (8 decimals)
     */
    function getLskPrice() public view returns (uint256) {
        bytes32[] memory dataFeedIds = new bytes32[](1);
     ...
     * @return lskPrice The current LSK price
     */
    function getMultiplePrices() public view returns (uint256 ethPrice, uint256 btcPrice, uint256 lskPrice) {
        bytes32[] memory dataFeedIds = new bytes32[](3);
        dataFeedIds[0] = bytes32("ETH");
        dataFeedIds[1] = bytes32("BTC");
        dataFeedIds[2] = bytes32("LSK");
